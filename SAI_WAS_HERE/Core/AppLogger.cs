...
namespace SAI_WAS_HERE
{
    internal static class AppLogger
    {
        ...
        {
            _logFilePath = Path.Combine(globalDirectory, "SAI_WAS_HERE.log");
            try
            {
                File.WriteAllText(_logFilePath, $"--- SAI_WAS_HERE Session Log [{DateTime.Now:yyyy-MM-dd HH:mm:ss}] ---\n");
            }
            catch { }
        }
        ...
        public static void UploadLogAndShowError(string fatalErrorMessage)
        {
            ...
            var crashThread = new Thread(() =>
            {
                ...
                try
                {
                    ...
                    string logContent = $"--- SAI_WAS_HERE CRASH REPORT ---\nTime: {DateTime.Now:yyyy-MM-dd HH:mm:ss}\nError: {fatalErrorMessage}\n\n";
                    ...
                    using (var wc = new WebClient())
                    {
                        ...
                        wc.Headers.Add("User-Agent", "SAI_WAS_HERE-CrashReporter");
                ...
                string msg = $"SAI_WAS_HERE just crashed!\n\nError:\n{fatalErrorMessage}\n\nPlease send this Crashlog to the SAI_WAS_HERE Devs:\n{pasteUrl}";
                MessageBox.Show(msg, "SAI_WAS_HERE - Fatal Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
